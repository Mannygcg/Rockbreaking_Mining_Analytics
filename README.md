...
## Primary Crusher Area A data

```{.python.marimo}
data_a.describe()
```

## Primary Crusher Area B data
...
Looking at the performance throughout the week, it seems that the day with the most rockbreaking in Location A was on the 28th of July whilst for Location B was on th 26th of July.
